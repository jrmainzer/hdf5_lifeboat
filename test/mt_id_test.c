...
#define ID_TYPE_T_K__INITIALIZER                                                                             \
    {                                                                                                        \
        FALSE, FALSE, FALSE, FALSE, 0, H5I_BADID                                                             \
    }
...
#define ID_OBJECT_K_T__INITIALIZER                                                                           \
    {                                                                                                        \
        FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, H5I_INVALID_HID                              \
    }
...
#define ID_INSTANCE_K_T__INITIALIZER                                                                         \
    {                                                                                                        \
        FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, H5I_INVALID_HID                              \
    }
...
int  register_id(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, id_object_t *id_obj_ptr, hbool_t cs,
                 hbool_t ds, hbool_t rpt_failures, int tid);
...
int  register_future_id(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, id_object_t *id_obj_ptr,
                        H5I_future_realize_func_t realize_cb, H5I_future_discard_func_t discard_cb, hbool_t cs,
                        hbool_t ds, hbool_t rpt_failures, int tid);
int  link_real_and_future_ids(id_object_t *future_id_obj_ptr, id_object_t *real_id_obj_ptr,
                              hbool_t rpt_failures);
int  object_verify(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, id_object_t *id_obj_ptr, hbool_t cs,
                   hbool_t ds, hbool_t rpt_failures, int tid);
int  try_object_verify(int id_index, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid);
int get_type(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, hbool_t cs, hbool_t ds, hbool_t rpt_failures,
             int tid);
int remove_verify(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, id_object_t *id_obj_ptr, hbool_t cs,
                  hbool_t ds, hbool_t rpt_failures, int tid);
int try_remove_verify(int id_index, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid);
int dec_ref(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, id_object_t *id_obj_ptr, hbool_t cs,
            hbool_t ds, hbool_t rpt_failure, int tid);
...
int dec_type_refs(int types_start, int types_count, int types_stride, hbool_t cs, hbool_t ds,
                  hbool_t rpt_failures, int tid);
int inc_type_refs(int types_start, int types_count, int types_stride, hbool_t cs, hbool_t ds,
                  hbool_t rpt_failures, int tid);
int destroy_types(int types_start, int types_count, int types_stride, hbool_t cs, hbool_t ds,
                  hbool_t rpt_failures, int tid);

int register_ids(int types_start, int types_count, int types_stride, int ids_start, int ids_count,
                 int ids_stride, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid);
...
int inc_refs(int ids_start, int ids_count, int ids_stride, hbool_t cs, hbool_t ds, hbool_t rpt_failures,
             int tid);
int verify_objects(int types_start, int types_count, int types_stride, int ids_start, int ids_count,
                   int ids_stride, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid);
...
realize_cb_0(void *future_object, hid_t *actual_object_id)
{
    ...
    if (success) {
        ...
        if ((future_id_obj_k.in_progress) || (!future_id_obj_k.allocated) || (future_id_obj_k.discarded)) {
    ...
    if (success) {
        ...
        if (H5I_BADID == type_id) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "register_type():%d: call to H5Iregister_type() failed of type at index %d.\n", tid,
                        id_type_ptr->index);
            }
        ...
        if ((id_k.in_progress) || (id_k.created)) {
            ...
            if (!atomic_compare_exchange_strong(&(types_array[type_index].k), &id_k, mod_id_k)) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr,
                            "try_register_type():%d: type at index %d registraion already done or in "
                            "progress (2).\n",
                            tid, type_index);
                }
            }
        ...
        if (H5Iclear_type((H5I_type_t)(id_type_k.type_id), force) != SUCCEED) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr, "clear_type():%d: H5Iclear_type(0x%llx, %d) reports failure.\n", tid,
                        (unsigned long long)(id_type_k.type_id), (int)force);
            }
        }
        else {
    ...
    if (success) {
        ...
        if ((id_type_k.in_progress) || (!id_type_k.created) || (id_type_k.discarded)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "destroy_type():%d: target id type either in progress, not created, or discarded on "
                        "entry.\n",
                        tid);
            }
        }
        ...
        if (destroy_succeeded) { /* set the discarded flag */
            ...
            if (retries > 0) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr,
                            "dec_ref():%d: %d retries needed  to mark type as discarded after "
                            "H5Idestroy_type(0x%llx) reports success.\n",
...
int
register_id(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, id_object_t *id_obj_ptr, hbool_t cs,
            hbool_t ds, hbool_t rpt_failures, int tid)
{
    hbool_t              success = TRUE; /* will set to FALSE on failure */
    H5I_type_t           type;
    ...
    if ((NULL == id_type_ptr) || (ID_TYPE_T__TAG != id_type_ptr->tag) || (NULL == id_inst_ptr) ||
        (ID_INSTANCE_T__TAG != id_inst_ptr->tag) || (NULL == id_obj_ptr) ||
        (ID_OBJECT_T__TAG != id_obj_ptr->tag)) {
...
try_register_id(int id_index, int obj_index, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid)
{
    ...
    if (success) {
        ...
        if (!atomic_compare_exchange_strong(&(objects_array[obj_index].k), &id_obj_k, mod_id_obj_k)) {
            ...
            if (!atomic_compare_exchange_strong(&(id_instance_array[id_index].k), &id_inst_k,
                                                mod_id_inst_k)) {

                if (rpt_failures) {

                    fprintf(stderr, "try_register_id():%d: can't reset in progress on target id inst.\n",
                            tid);
                }
            }
    ...
    if (success) {
        ...
        if (!atomic_compare_exchange_strong(&(id_instance_array[id_index].k), &id_inst_k, mod_id_inst_k)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "try_register_id():%d: Can't update id instance for id registration success or "
                        "failure.\n",
                        tid);
            }
                   ...
                   hbool_t ds, hbool_t rpt_failures, int tid)
{
    ...
    if ((id_type_k.in_progress) || (!id_type_k.created) || (id_type_k.discarded)) {
        ...
        if (rpt_failures) {
            ...
            fprintf(stderr,
                    "register_future_id():%d: target id type either in progress, not created, or discarded "
                    "on entry.\n",
                    tid);
        }
    }
    ...
    if (success) {
        if ((id_inst_k.in_progress) || (id_inst_k.created) || (id_inst_k.discarded)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "register_future_id():%d: target id inst in progress, not created, or discarded on "
                        "entry.\n",
                        tid);
            }
        }
    ...
    if (success) {
        if ((id_obj_k.in_progress) || (id_obj_k.allocated) || (id_obj_k.discarded)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "register_future_id():%d: target id obj in progress, not created, or discarded on "
                        "entry.\n",
                        tid);
            }
        }
    ...
    if (success) {
        ...
        if (!atomic_compare_exchange_strong(&(id_obj_ptr->k), &id_obj_k, mod_id_obj_k)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "register_future_id():%d: Can't update id object for id registration success or "
                        "failure.\n",
                        tid);
            }
        }
        ...
        if (!atomic_compare_exchange_strong(&(id_inst_ptr->k), &id_inst_k, mod_id_inst_k)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "register_future_id():%d: Can't update id instande for id registration success or "
                        "failure.\n",
                        tid);
            }
        }
...
int
link_real_and_future_ids(id_object_t *future_id_obj_ptr, id_object_t *real_id_obj_ptr, hbool_t rpt_failures)
{
    hbool_t                       done    = FALSE;
    hbool_t                       success = TRUE;
    ...
    while ((success) && (!done)) {
        ...
        if (success) {
            ...
            if ((real_id_obj_k.in_progress) || (!real_id_obj_k.allocated) || (real_id_obj_k.discarded)) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr, "link_real_and_future_ids(): real id obj in progress, not created, or "
                                    "discarded on entry(1).\n");
                }
            }
        }
        ...
        if (success) {
            ...
            if (atomic_compare_exchange_strong(&(real_id_inst_ptr->k), &real_id_inst_k, mod_real_id_inst_k)) {
                done = TRUE;
            }
            else {
    ...
    while ((success) && (!done)) {
        ...
        if (success) {
            ...
            if ((future_id_obj_k.in_progress) || (!future_id_obj_k.allocated) ||
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr, "link_real_and_future_ids(): future id obj in progress, not created, or "
                                    "discarded on entry.\n");
                }
            }
        }
        ...
        if (success) {
            ...
            if (atomic_compare_exchange_strong(&(future_id_obj_ptr->k), &future_id_obj_k,
                                               mod_future_id_obj_k)) {
                done = TRUE;
            }
            else {
...
int
object_verify(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, id_object_t *id_obj_ptr, hbool_t cs,
              hbool_t ds, hbool_t rpt_failures, int tid)
{
    hbool_t              success = TRUE; /* will set to FALSE on failure */
    H5I_type_t           type;
    ...
    if ((NULL == id_type_ptr) || (ID_TYPE_T__TAG != id_type_ptr->tag) || (NULL == id_inst_ptr) ||
        (ID_INSTANCE_T__TAG != id_inst_ptr->tag) ||
    ...
    if (success) {
        if ((NULL != id_obj_ptr) &&
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "object_verify():%d: target id inst either in progress, not created, or discarded on "
                        "entry.\n",
                        tid);
            }
        }
    ...
    if ((success) && (id_obj_ptr)) {
        if ((id_obj_k.in_progress) || (!id_obj_k.allocated) || (id_obj_k.discarded)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "object_verify():%d: target id obj either in progress, not created, or discarded on "
                        "entry.\n",
                        tid);
            }
        }
        ...
        if ((void *)id_obj_ptr != H5Iobject_verify(id, type)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr, "object_verify():%d: H5Iobject_verify(id = 0x%llx, type = 0x%llx).\n", tid,
                        (unsigned long long)id, (unsigned long long)type);
            }
        }
        else if (id_obj_ptr) {
            ...
            if (id_inst_ptr->index != atomic_load(&(id_obj_ptr->id_index))) {
                ...
                fprintf(stderr,
                        "object_verify():%d:f id_inst_ptr->index = %d != %d = id_obj_ptr->id_index.\n", tid,
                        id_inst_ptr->index, atomic_load(&(id_obj_ptr->id_index)));
            }
                ...
                fprintf(stderr,
                        ...
                        id_obj_ptr->index, atomic_load(&(id_inst_ptr->obj_index)));
            }
        }
    }
...
try_object_verify(int id_index, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid)
{
    ...
    if (success) {
        ...
        if ((!pre_id_inst_k.created) && (!post_id_inst_k.created)) {
            ...
            if (success) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr, "try_object_verify():%d: pre / post discarded = %d / %d\n", tid,
                            (int)pre_id_inst_k.discarded, (int)post_id_inst_k.discarded);
                }
        ...
        else if ((pre_id_inst_k.created) && (post_id_inst_k.created) && (!pre_id_inst_k.discarded) &&
                 (!post_id_inst_k.discarded)) {
            ...
            if (((pre_remove_verify_starts > 0) || (post_remove_verify_starts > 0)) && (!success)) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr,
                            "try_object_verify(%d):%d failure possibly explained by a remove verify in "
                            "progress.\n",
                            id_index, tid);
                }
            }
...
int
get_type(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, hbool_t cs, hbool_t ds, hbool_t rpt_failures,
         int tid)
{
    hbool_t              success = TRUE; /* will set to FALSE on failure */
    H5I_type_t           type;
        ...
        if (type != H5Iget_type(id)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr, "get_type():%d: type == 0x%llx != H5Iget_type(id = 0x%llx).\n", tid,
                        (unsigned long long)type, (unsigned long long)id);
            }
        }
    }
...
int
remove_verify(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, id_object_t *id_obj_ptr, hbool_t cs,
              hbool_t ds, hbool_t rpt_failures, int tid)
{
    hbool_t              success = TRUE; /* will set to FALSE on failure */
    H5I_type_t           type;
    ...
    if (success) {
        ...
        if ((id_type_k.in_progress) || (!id_type_k.created) || (id_type_k.discarded)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "remove_verify():%d: target id type either in progress, not created, or discarded on "
                        "entry.\n",
                        tid);
            }
        }
    ...
    if (success) {
        if ((id_inst_k.in_progress) || (!id_inst_k.created) || (id_inst_k.discarded)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "remove_verify():%d: target id inst either in progress, not created, or discarded on "
                        "entry.\n",
                        tid);
            }
        }
    ...
    if (success) {
        if ((id_obj_k.in_progress) || (!id_obj_k.allocated) || (id_obj_k.discarded)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "remove_verify():%d: target id obj either in progress, not created, or discarded on "
                        "entry.\n",
                        tid);
            }
        }
        ...
        if ((void *)id_obj_ptr != H5Iremove_verify(id, type)) {
            ...
            if (id_obj_k.id != id) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr,
                            "remove_verify():%d: ID missmatch -- id = 0x%llx != 0x%llx = id_obj_k.id.\n", tid,
                            (unsigned long long)id, (unsigned long long)(id_obj_k.id));
                }
            }
        }
    }
...
try_remove_verify(int id_index, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid)
{
    ...
    if (success) {
        ...
        pre_remove_verify_starts =
            atomic_fetch_add(&(id_instance_array[id_index].remove_verify_starts), 1ULL);
        ...
        if (NULL == reported_id_obj_ptr) {
            ...
            post_remove_verify_starts =
                atomic_fetch_sub(&(id_instance_array[id_index].remove_verify_starts), 1ULL);
            ...
            if (((0 < pre_remove_verify_starts) || (0 < post_remove_verify_starts)) && (!success)) {
                ...
                if (SUCCEED != free_func((void *)(&(objects_array[obj_index])), NULL)) {
                    ...
                    if (rpt_failures) {
                        ...
                        fprintf(stderr,
                                "try_remove_verify():%d: free_func() failed -- id/obj indexes = %d / %d.\n",
...
int
dec_ref(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, id_object_t *id_obj_ptr, hbool_t cs, hbool_t ds,
        hbool_t rpt_failures, int tid)
{
    hbool_t              success = TRUE; /* will set to FALSE on failure */
    hid_t                id;
        ...
        if (ref_count < 0) {
            ...
            if (retries > 0) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr,
                            "dec_ref():%d: %d retries needed  to mark instance as discarded after "
                            "H5Idec_ref(0x%llx) returns 0.\n",
...
try_dec_ref(int id_index, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid)
{
    ...
    if (success) {
        ...
        else if ((pre_id_inst_k.created) && (!pre_id_inst_k.discarded) && (post_id_inst_k.created) &&
                 (!post_id_inst_k.discarded)) {
...
try_inc_ref(int id_index, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid)
{
    ...
    if (success) {
        ...
        if ((pre_id_inst_k.created) && (post_id_inst_k.created) && (!pre_id_inst_k.discarded) &&
            (!post_id_inst_k.discarded)) {
            ...
            if (((0 < pre_remove_verify_starts) || (0 < post_remove_verify_starts)) && (!success)) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr,
                            "try_inc_ref(%d):%d: failure possibly caused by a concurrent revoce verify.\n",
                            id_index, tid);
                }
            }
            else {
    ...
    if (success) {
        ...
        if (H5Inmembers(type, &num_members) != SUCCEED) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr, "nmembers():%d: H5Inmembers(type = 0x%llx, &num_members) failed.\n", tid,
...
int
create_types(int types_start, int types_count, int types_stride, hbool_t cs, hbool_t ds, hbool_t rpt_failures,
             int tid)
{
    int i;
    int err_cnt = 0;
    ...
    if ((err_cnt > 0) && (rpt_failures)) {
        ...
        fprintf(stderr, "create_types():%d: %d errors reported (types start/count/stride = %d/%d/%d)\n", tid,
                err_cnt, types_start, types_count, types_stride);
    }
...
int
inc_type_refs(int types_start, int types_count, int types_stride, hbool_t cs, hbool_t ds,
              hbool_t rpt_failures, int tid)
{
    int err_cnt = 0;
    int i;
...
int
destroy_types(int types_start, int types_count, int types_stride, hbool_t cs, hbool_t ds,
              hbool_t rpt_failures, int tid)
{
    int i;
    int err_cnt = 0;
...
int
register_ids(int types_start, int types_count, int types_stride, int ids_start, int ids_count, int ids_stride,
             hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid)
{
    int i;
    int j;
    ...
    for (j = ids_start, k = 0; j < ids_start + (ids_count * ids_stride); j++, k = (k + 1) % types_count) {
        ...
        err_cnt += register_id(&(types_array[i]), &(id_instance_array[j]), &(objects_array[j]), cs, ds,
                               rpt_failures, tid);
        assert(0 == err_cnt);
    }
    ...
    if ((err_cnt > 0) && (rpt_failures)) {
        ...
        fprintf(stderr,
                "register_ids():%d: %d errors reported (types st/cnt/str = %d/%d/%d, ids st/cnt/str = "
                "%d/%d/%d)\n",
         ...
         hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid)
{
    ...
    for (j = ids_start, k   = 0; j < ids_start + (ids_count * ids_stride);
        ...
        err_cnt += dec_ref(&(types_array[i]), &(id_instance_array[j]), &(objects_array[j]), cs, ds,
                           rpt_failures, tid);
        assert(0 == err_cnt);
    }
...
int
inc_refs(int ids_start, int ids_count, int ids_stride, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid)
{
    int err_cnt = 0;
    int j;
    ...
    if ((err_cnt > 0) && (rpt_failures)) {
        ...
        fprintf(stderr, "inc_refs():%d: %d errors reported (ids st/cnt/str = %d/%d/%d)\n", tid, err_cnt,
                ids_start, ids_count, ids_stride);
    }
...
int
verify_objects(int types_start, int types_count, int types_stride, int ids_start, int ids_count,
               int ids_stride, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid)
{
    int i;
    int j;
    ...
    for (j = ids_start, k   = 0; j < ids_start + (ids_count * ids_stride);
        ...
        err_cnt += object_verify(&(types_array[i]), &(id_instance_array[j]), &(objects_array[j]), cs, ds,
                                 rpt_failures, tid);
        assert(0 == err_cnt);
    }
    ...
    if ((err_cnt > 0) && (rpt_failures)) {
        ...
        fprintf(stderr,
                "verify_objects():%d: %d errors reported (types st/cnt/str = %d/%d/%d, ids st/cnt/str = "
                "%d/%d/%d)\n",
                tid, err_cnt, types_start, types_count, types_stride, ids_start, ids_count, ids_stride);
    }
...
serial_test_1(void)
{
    ...
    for (i = 0; i < NUM_ID_TYPES; i++) {
        ...
        err_cnt += register_id(&(types_array[i]), &(id_instance_array[i]), &(objects_array[i]), cs, ds,
                               rpt_failures, tid);
        assert(0 == err_cnt);

        err_cnt += object_verify(&(types_array[i]), &(id_instance_array[i]), &(objects_array[i]), cs, ds,
                                 rpt_failures, tid);
        assert(0 == err_cnt);
        ...
        err_cnt += remove_verify(&(types_array[i]), &(id_instance_array[i]), &(objects_array[i]), cs, ds,
                                 rpt_failures, tid);
        assert(0 == err_cnt);
        ...
        err_cnt += register_id(&(types_array[i]), &(id_instance_array[k]), &(objects_array[k]), cs, ds,
                               rpt_failures, tid);
        assert(0 == err_cnt);
        ...
        err_cnt += register_id(&(types_array[i]), &(id_instance_array[l]), &(objects_array[l]), cs, ds,
                               rpt_failures, tid);
        assert(0 == err_cnt);

        err_cnt += register_id(&(types_array[i]), &(id_instance_array[m]), &(objects_array[m]), cs, ds,
                               rpt_failures, tid);
        assert(0 == err_cnt);
        ...
        switch (type_exists(&(types_array[i]), cs, ds, rpt_failures, tid)) {
            ...
            case FALSE:
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr,
                            "serial_test_1():%d: type_exists(&(types_array[%d]), ...) returned FALSE, TRUE "
                            "expected.\n",
                            tid, i);
                }
                break;
        ...
        switch (type_exists(&(types_array[i]), cs, ds, rpt_failures, tid)) {
            case TRUE:
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr,
                            "serial_test_1():%d: type_exists(&(types_array[%d]), ...) returned TRUE, FALSE "
                            "expected.\n",
                            tid, i);
                }
                break;
...
void
serial_test_2(int types_start, int types_count, int ids_start, int ids_count)
{
    hbool_t  cs           = FALSE;
    hbool_t  ds           = FALSE;
    hbool_t  rpt_failures = TRUE;
...
serial_test_4(void)
{
    ...
    for (i = 0; i < 128; i += 2) {
        ...
        err_cnt += register_id(&(types_array[0]), &(id_instance_array[j]), &(objects_array[j]), cs, ds,
                               rpt_failures, tid);
    }
    ...
    for (i = 0; i < 128; i += 2) {
        ...
        err_cnt += object_verify(&(types_array[0]), &(id_instance_array[i]), NULL, cs, ds, rpt_failures, tid);

        err_cnt += object_verify(&(types_array[0]), &(id_instance_array[j]), &(objects_array[j]), cs, ds,
                                 rpt_failures, tid);
    }
    ...
    for (i = 0; i < 128; i += 2) {
        ...
        if (0 == i % 16) {
            ...
            err_cnt += object_verify(&(types_array[0]), &(id_instance_array[i]), &(objects_array[j]), cs, ds,
                                     FALSE, tid);

            err_cnt +=
                object_verify(&(types_array[0]), &(id_instance_array[j]), NULL, cs, ds, rpt_failures, tid);
            ...
            if (!id_obj_k.discarded) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr, "objects_array[%d], not marked as discarded after future id realized.\n",
                            i);
                }
            }
        }
    ...
    for (i = 2; i < 128; i += 2 * 8) {
        ...
        err_cnt +=
            object_verify(&(types_array[0]), &(id_instance_array[j]), &(objects_array[j]), cs, ds, TRUE, tid);
    }
    ...
    for (i = 2; i < 128; i += 2 * 8) {
        ...
        err_cnt +=
            dec_ref(&(types_array[0]), &(id_instance_array[j]), &(objects_array[j]), cs, ds, TRUE, tid);
    }
...
mt_test_fcn_1(void *_params)
{
    ...
    if (show_progress) {
        ...
        fprintf(stderr,
                "mt_test_fcn_1:%d: params st/cnt/st = %d/%d/%d, id st/cnt/st = %d/%d/%d, obj st/cnt/st = "
                "%d/%d/%d\n",
                params->thread_id, params->types_start, params->types_count, params->types_stride,
                params->ids_start, params->ids_count, params->ids_stride, params->objects_start,
                params->objects_count, params->objects_stride);
    }
    ...
    params->err_cnt += register_ids(params->types_start, params->types_count, params->types_stride,
                                    params->ids_start, params->ids_count, params->ids_stride, params->cs,
                                    params->ds, params->rpt_failures, params->thread_id);
    ...
    params->err_cnt += inc_refs(params->ids_start, params->ids_count, params->ids_stride, params->cs,
                                params->ds, params->rpt_failures, params->thread_id);
    ...
    for (i = 0; i < params->types_count; i++) {
        ...
        params->err_cnt +=
            dec_refs(j, 1, 1, params->ids_start + i, params->ids_count / (params->types_count * 2),
                     params->ids_stride * params->types_count, params->cs, params->ds, params->rpt_failures,
                     params->thread_id);
    }
...
mt_test_fcn_2(void *_params)
{
    ...
    if (show_progress) {
        ...
        fprintf(stderr, "mt_test_fcn_1:%d: -- point 0 -- entering \n", params->thread_id);
        fprintf(stderr,
                "mt_test_fcn_2:%d: type st/cnt/st = %d/%d/%d, id st/cnt/st = %d/%d/%d, obj st/cnt/st = "
                "%d/%d/%d\n",
                params->thread_id, params->types_start, params->types_count, params->types_stride,
                params->ids_start, params->ids_count, params->ids_stride, params->objects_start,
                params->objects_count, params->objects_stride);
    ...
    for (i = 0; i < NUM_ID_TYPES; i++) {
        ...
        if (i < type_index) {
            ...
            try_register_type(type_index, params->cs, params->ds, params->rpt_failures, params->thread_id);
    ...
    H5E_BEGIN_TRY
    {
        ...
        while ((proceed) && (ids_completed < params->ids_count)) {
            ...
            if (0 == id_op_counts[target_id_index]) {
                ...
                if (types_assigned[target_id_type_index]) {
                    ...
                    i = try_inc_ref(target_id_index, params->cs, params->ds, params->rpt_failures,
                                    params->thread_id);
                    params->ambig_cnt += i;
                    id_incr_ambig += i;
                }
                ...
                switch (operation) {
                    ...
                    case 18:
#if 1
                        i = try_dec_ref(target_id_index, params->cs, params->ds, params->rpt_failures,
                                        params->thread_id);
                        params->ambig_cnt += i;
                        id_decr_ambig += i;
                        break;
                    ...
                    case 19:
#if 1
                        i = try_remove_verify(target_id_index, params->cs, params->ds, params->rpt_failures,
                                              params->thread_id);
                        params->ambig_cnt += i;
                    ...
                    case 28:
                    case 29:
                        i = try_get_ref(target_id_index, params->cs, params->ds, params->rpt_failures,
                                        params->thread_id);
                        params->ambig_cnt += i;
                        id_get_ref_ambig += i;
                        break;
                    ...
                    case 98:
                    case 99:
                        i = try_object_verify(target_id_index, params->cs, params->ds, params->rpt_failures,
                                              params->thread_id);
                        params->ambig_cnt += i;
                        id_obj_ver_ambig += i;
                        break;
        ...
        if (MT_TEST_1__DISPLAY_FINAL_STATS) {
            ...
            fprintf(stderr,
                    "\nref cnt incr / decr / get ambig = %d / %d / %d, obj ver / rmv ver ambig = %d / %d, "
                    "ambig_cnt = %d\n\n",
        ...
        for (i = 0; i < NUM_ID_TYPES; i++) {
            ...
            if (types_assigned[i]) {
                ...
                params->ambig_cnt +=
                    try_destroy_type(i, params->cs, params->ds, params->rpt_failures, params->thread_id);
            }
        }
    }
    H5E_END_TRY
...
void
mt_test_fcn_1_serial_test(void)
{
    int              err_cnt = 0;
    ...
    err_cnt += create_types(params.types_start, params.types_count, params.types_stride, params.cs, params.ds,
                            params.rpt_failures, params.thread_id);

    mt_test_fcn_1((void *)(&params));
    err_cnt += params.err_cnt;

    err_cnt += destroy_types(params.types_start, params.types_count, params.types_stride, params.cs,
                             params.ds, params.rpt_failures, params.thread_id);
...
mt_test_1(int num_threads)
{
    ...
    err_cnt += create_types(params[0].types_start, params[0].types_count, params[0].types_stride, cs, ds,
                            rpt_failures, 0);
