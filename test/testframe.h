 ...
 *
 * \param[in]  TestName            The chosen name for the test to be
 *                                 executed
 * \param[in]  TestFunc            The function to call when executing the
 *                                 test
 * \param[in]  TestSetupFunc       The function to call before executing the
 *                                 test
 * \param[in]  TestCleanupFunc     The function to call after executing the
 *                                 test
 * \param[in]  TestData            A pointer to additional data that will be
 *                                 passed to the test function and its setup
