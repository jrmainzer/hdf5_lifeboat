...
main(int argc, char *argv[])
{
    ...
    /* H5VL Tests */
    AddTest("mt_reg_unreg", mt_test_registration, NULL, NULL, &params, sizeof(mt_test_params),
            threaded_test_flag, "MT reg/unreg of a single connector");

    AddTest("mt_reg_by_name", mt_test_registration_by_name, NULL, NULL, &params, sizeof(mt_test_params),
            threaded_test_flag, "MT reg/unreg of a single connector by name");

    AddTest("mt_reg_by_val", mt_test_registration_by_value, NULL, NULL, &params, sizeof(mt_test_params),
            threaded_test_flag, "MT reg/unreg of a single connector by value");

    AddTest("mt_dyn_op_reg", mt_test_dyn_op_registration, NULL, NULL, &params, sizeof(mt_test_params),
            threaded_test_flag, "MT reg/unreg of dynamic optional VOL operations");

    AddTest("mt_fopen_fail", mt_test_file_open_failure_registration, NULL, NULL, &params,
            sizeof(mt_test_params), threaded_test_flag, "MT dynamic VOL loading on file open failure");

    AddTest("mt_lib_state_ops", mt_test_lib_state_ops, NULL, NULL, &params, sizeof(mt_test_params),
            threaded_test_flag, "MT usage of library state routines");

    AddTest("mt_vol_info", mt_test_vol_info, NULL, NULL, &params, sizeof(mt_test_params), threaded_test_flag,
    ...
    AddTest("mp_vol_wrp_ctx", mt_test_vol_wrap_ctx, NULL, mt_test_vol_wrap_ctx_cleanup, &params,
            sizeof(mt_test_params), no_threaded_test_flag, "MT usage of VOL wrap context routines");

    AddTest("mt_reg_search", mt_test_register_and_search, NULL, NULL, &params, sizeof(mt_test_params),
            no_threaded_test_flag, "MT reg/unreg of connectors while searching for connector");

    /* Misc MT tests */
    AddTest("mt_library_init", mt_test_library_init, NULL, NULL, &params, sizeof(mt_test_params),
            threaded_test_flag, "MT usage of H5open/H5close");
