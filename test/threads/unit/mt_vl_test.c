 ...
 * threads. */
void
mt_test_registration(const void *args)
{
    hid_t                *vol_ids;
    herr_t                ret       = SUCCEED;
 ...
 * threads. */
void
mt_test_registration_by_name(const void *args)
{
 ...
 * threads. */
void
mt_test_registration_by_value(const void *args)
{
#ifndef H5_MT_TEST_VOL_DIR
    printf("Skipping test because H5_MT_TEST_VOL_DIR is not defined\n");
    return;
...
void
mt_test_dyn_op_registration(const void H5_ATTR_UNUSED *args)
{
...
void
mt_test_registration_operation(const void *args)
{
...
void *
mt_test_registration_operation_helper(void *args)
{
    hid_t                   *vol_ids;
...
void
mt_test_registration_operation_cleanup(void H5_ATTR_UNUSED *args)
{
    herr_t ret = SUCCEED;
...
void
mt_test_file_open_failure_registration(const void H5_ATTR_UNUSED *args)
{
#ifndef H5_MT_TEST_VOL_DIR
    printf("Skipping test because H5_MT_TEST_VOL_DIR is not defined\n");
    return;
 ...
 * correctly */
void
mt_test_vol_property_copy(const void *args)
{
    hid_t  fapl_id = H5I_INVALID_HID;
    herr_t ret     = SUCCEED;
...
void *
mt_test_vol_property_copy_helper(void *args)
{
    hid_t  fapl_id  = H5I_INVALID_HID;
 ...
 */
void
mt_test_register_and_search(const void *args)
{
    ...
    for (i = 0; i < threads_per_group; i++) {
        ret =
            pthread_create(&threads_register[i], NULL, mt_test_search_register_helper, (void *)&helper_args);
...
void *
mt_test_search_register_helper(void *args)
{
    hid_t                    vol_id      = H5I_INVALID_HID;
...
void *
mt_test_search_search_by_name_helper(void *args)
{
    hid_t                    vol_id = H5I_INVALID_HID;
    size_t                   i;
    mt_test_reg_helper_args *helper_args = (mt_test_reg_helper_args *)args;
...
void *
mt_test_search_search_by_value_helper(void *args)
{
    hid_t                    vol_id = H5I_INVALID_HID;
    size_t                   i;
    mt_test_reg_helper_args *helper_args = (mt_test_reg_helper_args *)args;
...
void
mt_test_lib_state_ops(const void H5_ATTR_UNUSED *args)
{
    void  *lib_state = NULL;
    herr_t ret       = SUCCEED;
...
void
mt_test_vol_wrap_ctx(const void *args)
{
    hid_t  file_id         = H5I_INVALID_HID;
    herr_t ret             = SUCCEED;
    hid_t  fapl_id         = H5I_INVALID_HID;
...
void *
mt_test_vol_wrap_ctx_helper(void H5_ATTR_UNUSED *args)
{
    void          *wrap_ctx   = NULL;
...
void
mt_test_vol_wrap_ctx_cleanup(void H5_ATTR_UNUSED *args)
{
 ...
 * so should probably have a counterpart placed in the API tests for use with various VOL connectors. */
void
mt_test_vol_info(const void H5_ATTR_UNUSED *args)
{
