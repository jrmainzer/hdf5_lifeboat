...
main(int argc, char *argv[])
{
    ...
    AddTest("is_threadsafe", tts_is_threadsafe, NULL, NULL, NULL, 0, 0, "library threadsafe status");

#if defined(H5_HAVE_THREADSAFE) || defined(H5_HAVE_MULTITHREAD)
    AddTest("errstk", tts_errstk, NULL, NULL, NULL, 0, 0, "error stack cleanup");
#endif

#ifdef H5_HAVE_THREADSAFE
    AddTest("dcreate", tts_dcreate, NULL, cleanup_dcreate, NULL, 0, 0, "multi-dataset creation");
    AddTest("error", tts_error, NULL, cleanup_error, NULL, 0, 0, "per-thread error stacks");
#ifdef H5_HAVE_PTHREAD_H
    /* Thread cancellability only supported with pthreads ... */
    AddTest("cancel", tts_cancel, NULL, cleanup_cancel, NULL, 0, 0, "thread cancellation safety test");
#endif /* H5_HAVE_PTHREAD_H */
    AddTest("acreate", tts_acreate, NULL, cleanup_acreate, NULL, 0, 0, "multi-attribute creation");
    AddTest("attr_vlen", tts_attr_vlen, NULL, cleanup_attr_vlen, NULL, 0, 0, "multi-file-attribute-vlen read");
