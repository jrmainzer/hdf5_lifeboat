...
main(int argc, char *argv[])
{
    ...
    AddTest("config", test_configure, NULL, cleanup_configure, NULL, 0, 0, "Configure definitions");
    AddTest("h5system", test_h5_system, NULL, cleanup_h5_system, NULL, 0, 0, "H5system routines");
    AddTest("metadata", test_metadata, NULL, cleanup_metadata, NULL, 0, 0, "Encoding/decoding metadata");
    AddTest("checksum", test_checksum, NULL, cleanup_checksum, NULL, 0, 0, "Checksum algorithm");
    AddTest("skiplist", test_skiplist, NULL, NULL, NULL, 0, 0, "Skip Lists");
    AddTest("refstr", test_refstr, NULL, NULL, NULL, 0, 0, "Reference Counted Strings");
    AddTest("file", test_file, NULL, cleanup_file, NULL, 0, 0, "Low-Level File I/O");
    AddTest("objects", test_h5o, NULL, cleanup_h5o, NULL, 0, 0, "Generic Object Functions");
    AddTest("h5s", test_h5s, NULL, cleanup_h5s, NULL, 0, 0, "Dataspaces");
    AddTest("coords", test_coords, NULL, cleanup_coords, NULL, 0, 0, "Dataspace coordinates");
    AddTest("sohm", test_sohm, NULL, cleanup_sohm, NULL, 0, 0, "Shared Object Header Messages");
    ...
    AddTest("iterate", test_iterate, NULL, cleanup_iterate, NULL, 0, 0, "Group & Attribute Iteration");
    AddTest("array", test_array, NULL, cleanup_array, NULL, 0, 0, "Array Datatypes");
    AddTest("genprop", test_genprop, NULL, cleanup_genprop, NULL, 0, 0, "Generic Properties");
    AddTest("unicode", test_unicode, NULL, cleanup_unicode, NULL, 0, 0, "UTF-8 Encoding");
    AddTest("id", test_ids, NULL, NULL, NULL, 0, 0, "User-Created Identifiers");
    AddTest("misc", test_misc, NULL, cleanup_misc, NULL, 0, 0, "Miscellaneous");
