...
void                   lfht_discard_node(struct lfht_t *lfht_ptr, struct lfht_node_t *node_ptr,
                                         unsigned int expected_ref_count);
...
void                lfht_find_mod_point(struct lfht_t *lfht_ptr, struct lfht_node_t *bucket_head_ptr,
                                        ...
                                        int *cols_ptr, int *dels_ptr, int *nodes_visited_ptr, unsigned long long int hash);
