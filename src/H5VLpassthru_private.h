...
/* Attribute callbacks */
H5_DLL void  *H5VL_pass_through_attr_create(void *obj, const H5VL_loc_params_t *loc_params,
                                            const char *attr_name, hid_t type_id, hid_t space_id,
                                            hid_t acpl_id, hid_t aapl_id, hid_t dxpl_id, void **req);
H5_DLL void  *H5VL_pass_through_attr_open(void *obj, const H5VL_loc_params_t *loc_params,
...
H5_DLL herr_t H5VL_pass_through_attr_write(void *attr, hid_t dtype_id, const void *buf, hid_t dxpl_id,
                                           void **req);
...
H5_DLL herr_t H5VL_pass_through_attr_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id,
                                              void **req);
H5_DLL herr_t H5VL_pass_through_attr_close(void *attr, hid_t dxpl_id, void **req);

/* Dataset callbacks */
H5_DLL void  *H5VL_pass_through_dataset_create(void *obj, const H5VL_loc_params_t *loc_params,
...
H5_DLL herr_t H5VL_pass_through_dataset_read(size_t count, void *obj[], hid_t mem_type_id[],
                                             hid_t mem_space_id[], hid_t file_space_id[], hid_t dxpl_id,
                                             void *buf[], void **req);
H5_DLL herr_t H5VL_pass_through_dataset_write(size_t count, void *obj[], hid_t mem_type_id[],
                                              hid_t mem_space_id[], hid_t file_space_id[], hid_t dxpl_id,
                                              const void *buf[], void **req);
H5_DLL herr_t H5VL_pass_through_dataset_get(void *dset, H5VL_dataset_get_args_t *args, hid_t dxpl_id,
                                            void **req);
H5_DLL herr_t H5VL_pass_through_dataset_specific(void *dset, H5VL_dataset_specific_args_t *args,
...
/* Datatype callbacks */
H5_DLL void *H5VL_pass_through_datatype_commit(void *obj, const H5VL_loc_params_t *loc_params,
...
H5_DLL void *H5VL_pass_through_datatype_open(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
                                             hid_t tapl_id, hid_t dxpl_id, void **req);
H5_DLL herr_t H5VL_pass_through_datatype_get(void *dt, H5VL_datatype_get_args_t *args, hid_t dxpl_id,
                                             void **req);
H5_DLL herr_t H5VL_pass_through_datatype_specific(void *dt, H5VL_datatype_specific_args_t *args,
                                                  hid_t dxpl_id, void **req);
H5_DLL herr_t H5VL_pass_through_datatype_optional(void *dt, H5VL_optional_args_t *args, hid_t dxpl_id,
                                                  void **req);
...
H5_DLL herr_t H5VL_pass_through_file_specific(void *file, H5VL_file_specific_args_t *args, hid_t dxpl_id,
                                              void **req);
H5_DLL herr_t H5VL_pass_through_file_optional(void *file, H5VL_optional_args_t *args, hid_t dxpl_id,
                                              void **req);
...
H5_DLL herr_t H5VL_pass_through_group_specific(void *obj, H5VL_group_specific_args_t *args, hid_t dxpl_id,
                                               void **req);
H5_DLL herr_t H5VL_pass_through_group_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id,
                                               void **req);
...
/* Object callbacks */
H5_DLL void  *H5VL_pass_through_object_open(void *obj, const H5VL_loc_params_t *loc_params,
