...
main(int argc, char *argv[])
{
    try {
        ...
        AddTest("dsets", test_dset, NULL, cleanup_dsets, NULL, 0, 0, "Dataset I/O Operations");
        // testing dataspace functionalities in th5s.cpp
        AddTest("th5s", test_h5s, NULL, cleanup_h5s, NULL, 0, 0, "Dataspaces");
        // testing attribute functionalities in tattr.cpp
        AddTest("tattr", test_attr, NULL, cleanup_attr, NULL, 0, 0, "Attributes");
        // testing object functionalities in tobject.cpp
        AddTest("tobject", test_object, NULL, cleanup_object, NULL, 0, 0, "Objects");
        // testing reference functionalities in trefer.cpp
        AddTest("trefer", test_reference, NULL, cleanup_reference, NULL, 0, 0, "References");
        // testing variable-length strings in tvlstr.cpp
        AddTest("tvlstr", test_vlstrings, NULL, cleanup_vlstrings, NULL, 0, 0, "Variable-Length Strings");
        AddTest("ttypes", test_types, NULL, cleanup_types, NULL, 0, 0, "Generic Data Types");
        AddTest("tarray", test_array, NULL, cleanup_array, NULL, 0, 0, "Array Datatypes");
        AddTest("tcompound", test_compound, NULL, cleanup_compound, NULL, 0, 0, "Compound Data Types");
        AddTest("tdspl", test_dsproplist, NULL, cleanup_dsproplist, NULL, 0, 0, "Dataset Property List");
        AddTest("tfilter", test_filters, NULL, cleanup_filters, NULL, 0, 0, "Various Filters");
        AddTest("tlinks", test_links, NULL, cleanup_links, NULL, 0, 0, "Various Links");
